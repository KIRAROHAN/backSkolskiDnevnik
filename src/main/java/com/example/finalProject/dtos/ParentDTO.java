...
public class ParentDTO {
    ...
    @NotNull(message = "Email za notifikaciju mora biti dat.")
   	@Pattern(regexp = "^[_A-Za-z0-9-\\+]+(\\.[_A-Za-z0-9-]+)*@"
   			+ "[A-Za-z0-9-]+(\\.[A-Za-z0-9]+)*(\\.[A-Za-z]{2,})$", message = "Email za notifikaciju nije validan.")
    private String emailZaNotifikaciju;
	...
	public String getEmailZaNotifikaciju() {
		return emailZaNotifikaciju;
	}

	public void setEmailZaNotifikaciju(String emailZaNotifikaciju) {
		this.emailZaNotifikaciju = emailZaNotifikaciju;
	}
